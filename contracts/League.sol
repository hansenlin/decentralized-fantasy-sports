...
contract League {
  ...
  function getGame(address _team, uint8 _week) public view returns(address, uint8, uint8, uint8, bool) {
    Game storage game = teamsMap[_team].schedule[_week];
    return (game.opponent, game.teamScore, game.opponentScore, game.approvalCount, game.scoresSet);
  }
